...
import { MapPin, Users, Clock, Star, Building2, Search, Filter, ChevronDown, Flag } from 'lucide-react';
...
export default function CourtsPage() {
  ...
  // Debug logging
  console.log('CourtsPage - User object:', user);
  console.log('CourtsPage - User role:', user?.role);
  console.log('CourtsPage - User role lowercase:', user?.role?.toLowerCase());
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      {/* Flag button - Debug version - should show for players */}
                      ...
                      {true && ( // Temporarily always show for debugging
                        <button 
                          onClick={(e) => {
                            ...
                            console.log('Flag clicked - User role:', user?.role);
                          ...
                          title={`Report Court Issue (User: ${user?.role || 'not logged in'})`}
                        >
                          <Flag size={16} />
                        </button>
                      )}
